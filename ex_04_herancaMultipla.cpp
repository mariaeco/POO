/*
Exercício 2 - HERANCA
Crie três classes: Pessoa, Funcionario e Aluno. 
A classe Pessoa deve ter os atributos nome e idade e a classe Funcionario deve ter os atributos salário e cargo.
 A classe Aluno deve ter o atributo curso. Em seguida, crie uma classe chamada EstudanteTrabalhador 
 que herda de Funcionario e Aluno, e possui um atributo chamado horasTrabalhadas. 
 Crie um método chamado imprimirDados que exibe as informações da pessoa, do funcionário, 
 do aluno e as horas trabalhadas.
 */
#include <iostream>
#include <string.h>
